...
DROP TABLE IF EXISTS TB_CRYPTO_BEST_PRICE_SNAPSHOT;
...
CREATE TABLE TB_CRYPTO_BEST_PRICE_SNAPSHOT (
    SEQNO BIGINT PRIMARY KEY,
    CURRENCY_PAIR VARCHAR(50) NOT NULL,
    BID_SOURCE VARCHAR(50) NOT NULL,
    BID_PRICE DECIMAL(20, 8) NOT NULL,
    ASK_SOURCE VARCHAR(50) NOT NULL,
...
CREATE INDEX IDX_CURRENCY_PAIR ON TB_CRYPTO_BEST_PRICE_SNAPSHOT(CURRENCY_PAIR);
CREATE INDEX IDX_CRE_ON ON TB_CRYPTO_BEST_PRICE_SNAPSHOT(CRE_ON);
